...
class Ripple:
    ...
    def add_values(self, bg_value: list, time_value: list, trend_value: list):
        ...
        self._get_duration()
        self._get_average_glucose()
        self._compute_min_max_value_time()
    ...
    def _compute_min_max_value_time(self):
        """
    ...
    def write_image_to_file(self, i: int):
        """
        ...
        legend_values = self._generate_legend()
